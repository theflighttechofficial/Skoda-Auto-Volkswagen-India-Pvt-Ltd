...
export const VW_MODELS: CarModel[] = [
  ...
  },
  {
    id: 'jetta-gli',
    image: '/cars/jetta.jpg',
    enthusiastNote: 'The GLI badge — "Gran Luxe Injection" — has run on the Jetta since 1983, making it Volkswagen\'s longest continuously-produced sports sedan nameplate. It is included here purely as a global enthusiast reference — Volkswagen does not officially sell the Jetta GLI in India.',
    notSoldInIndia: true,
    name: 'Volkswagen Jetta GLI',
    badge: 'Not Sold in India — Global Enthusiast Icon',
    tagline: 'A GTI in a three-box suit — 228 PS of EA888 punch, firm GLI-tuned suspension, and a proper boot for track-day gear. Not officially sold in India; shown for reference only.',
    bodyType: 'Compact Sedan',
    startingPrice: 'Not Sold in India',
    startingExShowroom: 3950000,
    priceRange: 'Not Sold in India (Global Market Only)',
    rating: '5-Star Euro NCAP',
    safetyStars: 5,
    ...
    variants: [
      {
        id: 'jetta-gli-cbu',
        name: 'Jetta GLI',
        tagline: 'The fully-loaded global GLI sports sedan package — not officially sold in India',
        priceRange: 'Not Sold in India',
