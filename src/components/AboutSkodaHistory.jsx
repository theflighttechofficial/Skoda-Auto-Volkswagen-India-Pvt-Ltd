            ...
            <p className="text-zinc-300 text-base sm:text-lg leading-relaxed max-w-3xl">
              {isScania ? (
                <>
                  ...
                  merger in Södertälje, to the first{" "}
                  <span className="text-rose-400 font-semibold">
                    Scania V8
                  </span>{" "}
                  in 1969, full Volkswagen Group ownership since 2014 under
                  the TRATON Group, and the{" "}
                  <span className="text-rose-400 font-semibold">
                    Narsapura plant
                  </span>{" "}
                  building trucks and buses for India since 2013, discover
                  Scania's celebrated engineering odyssey.
                </>
              ) : isSeat ? (
                <>
        ...
        <div className="rounded-3xl bg-gradient-to-r from-zinc-900 via-zinc-900 to-zinc-950 border border-rose-900/40 p-6 sm:p-8 space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="space-y-1 max-w-2xl">
              <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-rose-400">
                <Globe2 className="w-4 h-4" />
                <span>Scania India Manufacturing & Dealer Network</span>
              </div>
              <h3 className="text-2xl font-black text-white">
                Manufactured, Not Imported: Scania's Narsapura Model
              </h3>
              <p className="text-zinc-400 text-xs sm:text-sm">
                Unlike SEAT (absent from India) or Bentley/Lamborghini (CBU
                import), Scania genuinely manufactures for the Indian market:
                the Narsapura plant near Bengaluru has assembled R- and
                S-series tractors since 2013, and Scania Commercial Vehicles
                India Pvt. Ltd. runs its own direct-owned and franchised
                dealer/workshop network — independent of Škoda Auto
                Volkswagen India (SAVWIPL) but a genuine sibling under the
                same TRATON / Volkswagen Group umbrella.
              </p>
            </div>
            <div className="flex items-center gap-2">
              <div className="px-3 py-1.5 rounded-xl font-black text-xs flex items-center gap-1.5 bg-rose-500/10 border border-rose-500/30 text-rose-300">
                <ShieldCheck className="w-4 h-4" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-5 rounded-2xl bg-zinc-950/80 border border-zinc-800/80 space-y-2">
              <div className="flex items-center justify-between">
                <h4 className="font-bold text-white text-sm">
                  Narsapura Manufacturing Plant
                </h4>
                <span className="text-[10px] font-bold px-2 py-0.5 rounded border text-rose-400 bg-rose-950 border-rose-800">
                  Since 2013
                </span>
              </div>
              <p className="text-xs text-zinc-400 leading-relaxed">
                Scania's first fully-owned manufacturing facility outside
                Europe at the time it opened, assembling the R- and S-series
                tractor range and supplying chassis for Citywide and
                Metrolink bus bodies.
              </p>
            </div>
            ...
            <div className="p-5 rounded-2xl bg-zinc-950/80 border border-zinc-800/80 space-y-2">
              <div className="flex items-center justify-between">
                <h4 className="font-bold text-white text-sm">
                  Direct Dealer & Workshop Network
                </h4>
                <span className="text-[10px] font-bold px-2 py-0.5 rounded border text-rose-400 bg-rose-950 border-rose-800">
              ...
              <p className="text-xs text-zinc-400 leading-relaxed">
                Scania Commercial Vehicles India operates its own
                direct-owned and franchised dealer/workshop network,
                including full fleet warranty and service contracts —
