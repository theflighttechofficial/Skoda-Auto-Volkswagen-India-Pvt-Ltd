  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      ...
      <div className="text-center space-y-2">
        <div
          className={`inline-flex items-center gap-2 px-3 py-1 rounded-full border text-xs font-semibold ${isSeat ? "bg-orange-950/80 border-orange-800 text-orange-400" : isBentley ? "bg-green-950/80 border-green-800 text-green-400" : isLamborghini ? "bg-yellow-950/80 border-yellow-800 text-yellow-400" : isPorsche ? "bg-amber-950/80 border-amber-800 text-amber-400" : isAudi ? "bg-red-950/80 border-red-800 text-red-400" : isVW ? "bg-blue-950/80 border-blue-800 text-blue-400" : "bg-emerald-950/80 border-emerald-800 text-emerald-400"}`}
        >
          {isSeat ? (
      ...
      <div className="flex flex-wrap justify-center gap-2">
        {categories.map((cat) => (
          <button
            ...
            className={`px-3.5 py-1.5 rounded-lg text-xs font-semibold transition-all cursor-pointer ${activeCategory === cat ? (isSeat ? "bg-orange-600 text-white shadow-sm" : isBentley ? "bg-green-600 text-white shadow-sm" : isLamborghini ? "bg-yellow-600 text-white shadow-sm" : isPorsche ? "bg-amber-600 text-white shadow-sm" : isAudi ? "bg-red-600 text-white shadow-sm" : isVW ? "bg-blue-600 text-white shadow-sm" : "bg-emerald-600 text-white shadow-sm") : "bg-zinc-900 text-zinc-400 border border-zinc-800 hover:text-white"}`}
          >
            {cat}
          </button>
        ))}
            ...
            >
              ...
              >
                <div className="flex items-center gap-3">
                  <span
                    className={`text-[10px] uppercase font-bold px-2 py-0.5 rounded bg-zinc-800 border border-zinc-700 ${isSeat ? "text-orange-400" : isBentley ? "text-green-400" : isLamborghini ? "text-yellow-400" : isPorsche ? "text-amber-400" : isAudi ? "text-red-400" : isVW ? "text-blue-400" : "text-emerald-400"}`}
                  >
                    {faq.category}
                  </span>
                ...
                <ChevronDown
                  className={`w-4 h-4 text-zinc-400 transition-transform duration-200 flex-shrink-0 ${isOpen ? (isSeat ? "rotate-180 text-orange-400" : isBentley ? "rotate-180 text-green-400" : isLamborghini ? "rotate-180 text-yellow-400" : isPorsche ? "rotate-180 text-amber-400" : isAudi ? "rotate-180 text-red-400" : isVW ? "rotate-180 text-blue-400" : "rotate-180 text-emerald-400") : ""}`}
                />
              </button>
