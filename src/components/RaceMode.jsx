...
const BRAND_ACCENT = { skoda: "#10b981", volkswagen: "#3b82f6", audi: "#ef4444", porsche: "#f59e0b", lamborghini: "#eab308", bentley: "#16a34a", seat: "#f97316" };
...
export const RaceMode = ({ brand = "skoda" }) => {
  ...
  const accentText = brand === "audi" ? "text-red-400" : brand === "volkswagen" ? "text-blue-400" : brand === "porsche" ? "text-amber-400" : brand === "lamborghini" ? "text-yellow-400" : brand === "bentley" ? "text-green-400" : brand === "seat" ? "text-orange-400" : "text-emerald-400";
  const accentBg = brand === "audi" ? "bg-red-600 hover:bg-red-500" : brand === "volkswagen" ? "bg-blue-600 hover:bg-blue-500" : brand === "porsche" ? "bg-amber-600 hover:bg-amber-500" : brand === "lamborghini" ? "bg-yellow-600 hover:bg-yellow-500" : brand === "bentley" ? "bg-green-600 hover:bg-green-500" : brand === "seat" ? "bg-orange-600 hover:bg-orange-500" : "bg-emerald-600 hover:bg-emerald-500";
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
        {roster.map((r) => {
          ...
          const brandColor = r.brand === "audi" ? "text-red-400" : r.brand === "volkswagen" ? "text-blue-400" : r.brand === "porsche" ? "text-amber-400" : r.brand === "lamborghini" ? "text-yellow-400" : r.brand === "bentley" ? "text-green-400" : r.brand === "seat" ? "text-orange-400" : "text-emerald-400";
          return (
            <button
              key={r.id}
