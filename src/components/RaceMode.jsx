...
export const RaceMode = ({ brand = "skoda" }) => {
  ...
  const accentText = brand === "audi" ? "text-red-400" : brand === "volkswagen" ? "text-blue-400" : "text-emerald-400";
  const accentBg = brand === "audi" ? "bg-red-600 hover:bg-red-500" : brand === "volkswagen" ? "bg-blue-600 hover:bg-blue-500" : "bg-emerald-600 hover:bg-emerald-500";
                ...
                return (
                  <div key={r.id} className="relative">
                    ...
                    <div className="relative h-10 rounded-lg bg-zinc-900 border border-zinc-800 overflow-hidden">
                      ...
                      >
                        <CarSilhouette colorHex={r.heroColorHex} isSedan={r.isSedan} accentHex={BRAND_ACCENT[r.brand]} />
                      </motion.div>
                    </div>
                  </div>
                );
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
        {roster.map((r) => {
          ...
          const brandColor = r.brand === "audi" ? "text-red-400" : r.brand === "volkswagen" ? "text-blue-400" : "text-emerald-400";
          return (
            <button
              key={r.id}
