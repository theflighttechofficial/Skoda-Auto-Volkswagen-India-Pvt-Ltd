...
export const UnderTheSkin = ({ brand = "skoda", onSwitchBrand }) => {
  ...
  const accentBorder = brand === "audi" ? "border-red-500/60" : brand === "volkswagen" ? "border-blue-500/60" : brand === "porsche" ? "border-amber-500/60" : brand === "lamborghini" ? "border-yellow-500/60" : brand === "bentley" ? "border-green-500/60" : brand === "seat" ? "border-orange-500/60" : "border-emerald-500/60";
